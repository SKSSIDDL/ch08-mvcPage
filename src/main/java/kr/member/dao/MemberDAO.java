...
public class MemberDAO {
	...
	public MemberVO checkMember(String id)throws Exception{
		...
		try{
			conn = DBUtil.getConnection();
			//zmember와 zmember_detail 조인시 zmember의 누락된 데이터가 보여야 id 중복체크가 가능(=>left outer join 사용)
	...
	//목록, 검색 목록
	public List<MemberVO> getListMemberByAdimin(int start, int end, String keyfield, String keyword)throws Exception{
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
